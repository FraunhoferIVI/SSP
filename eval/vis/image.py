...
with warnings.catch_warnings():
    ...
    from utils.metrics import pixel_accuracy, meanIoU, weightedIoU, class_meanIoU, video_consistency, temporal_consistency, get_flow_model, MetricMeter, PerClassMetricMeter
